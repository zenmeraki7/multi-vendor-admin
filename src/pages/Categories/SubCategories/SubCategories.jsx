  ...
  useEffect(() => {
    const fetchSubCategories = async () => {
      try {
        ...
        const response = await axios.get(`${BASE_URL}/api/subcategory/all-admin`, {
          headers: {
        ...
        setCategories(uniqueCategories); // Update the categories list
      } catch (error) {
          ...
          <TableBody>
            {filteredSubCategories.map((subcategory, index) => (
              <TableRow
                key={subcategory._id}
                sx={{
                  backgroundColor: index % 2 === 0 ? "white" : "background.default",
                }}
              >
                ...
                <TableCell>
                  <Button
                    ...
                    size="small"
                    color="primary"
                    onClick={() => navigate(`/view-subcategory/${subcategory._id}`)}                  >
                    View
                  </Button>
                </TableCell>
              </TableRow>
